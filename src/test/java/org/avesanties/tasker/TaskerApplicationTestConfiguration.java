...
abstract class TaskerApplicationTestConfiguration {
  ...
  @Container
  private static PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>(RDBMS_VERSION)
      .withUsername(POSTGRES_USERNAME).withPassword(POSTGRES_PASSWORD).withDatabaseName(APP_DB);
